package com.example.cameratest.landmarkerhelper
...
class HandLandmarkerHelper(
    ...
    lateinit var handBitmap: Bitmap
    ...
    fun captureHand(captureCallback : (Bitmap) -> Unit) {
        captureCallback.invoke(handBitmap)
    }
